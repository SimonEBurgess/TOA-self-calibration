function [xopt,yopt,resVec]=bundleL1IteratedToaMics2DSounds3D(D, I,J, rec, send, lambda, maxIterOuter, maxIterInner)
...
for ii=1:maxIterOuter
    ...
    [recPost,sendPost]=bundleToaMics2DSounds3D(D,I,J,xopt,yopt,lambda,0,weights,maxIterInner);
...
V = [rec(:,I) ; zeros(1,length(I))]-send(:,J); %Just the differences of the positions r_i-s_j, for all combinations
